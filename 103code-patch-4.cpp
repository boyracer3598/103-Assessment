    ...
    for (int i = 0; i < result.size(); i++) {
        if (result.at(i).first == currentUsername) {
            ...
            if (choice == 'y') {
                ...
                file << currentUsername << "," << RegoNum << "," << phone << "," << email << "," << address << "," << startDate << "," << carMake << "," << carModel << "," << carYear << "," << policyNum << "," << policyType << endl;
                file.close();
                Sleep(3000);
...
void displayClaims(int claimsType) {
    ...
    cout << "You have selected: " << claimsTypeStr << endl;
    vector<pair<string, vector<string>>> result = read_csv("Customer_registration.csv");
    for (int i = 0; i < result.size(); i++) {
        if (result.at(i).first == currentUsername) {
    ...
    if (access == true) {
        ...
        while (true) {
            ...
            if (CustomerChoice == 1) {
                ...
                cout << "Claims" << endl;
                cout << "Please select the policy type you would like to make a claim for:" << endl;
                cout << "1. Comprehensive" << endl;
                cout << "2. Third Party Fire & Theft" << endl;
                cout << "3. Third Party Only" << endl;
                cout << "4. Back" << endl;
                int claimsChoice = validInput();
                if (claimsChoice == 1) {
                    displayClaims(1);
                }else if (claimsChoice == 2) {
                    displayClaims(2);
                }else if (claimsChoice == 3) {
                    displayClaims(3);
                }else if (claimsChoice == 4) {
                    break;
                }
