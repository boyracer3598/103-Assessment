        ...
        while (true) {
            ...
            if (CustomerChoice == 1) {
                ...
                if (choice == "y") {
                    ...
                    for (int i = 0; i < result.size(); i++) {
                        if (result.at(i).first == currentUsername) {
                            cout << "Your current policy type is: " << result.at(i).second.at(9) << endl;
                            cout << "Would you like to renew your policy? (y/n): ";
                            char renewChoice;
                            cin >> renewChoice;
                            if (renewChoice == 'y') {
                                //check the policy type and calculate the renewal cost
                                if (result.at(i).second.at(9) == "comprehensive") {
                                    ...
                                    file << currentUsername << "," << result.at(i).second.at(1) << "," << result.at(i).second.at(2) << "," << result.at(i).second.at(3) << "," << result.at(i).second.at(4) << "," << result.at(i).second.at(5) << "," << result.at(i).second.at(6) << "," << result.at(i).second.at(7) << "," << result.at(i).second.at(8) << "," << result.at(i).second.at(9) << "," << result.at(i).second.at(10) << "," << currentDate << "," << cardNum << endl;
                                    file.close();
                                }else if (result.at(i).second.at(9) == "third party fire & theft") {
                                    cout << "The renewal cost for your Third Party Fire & Theft policy is $45 per month." << endl;
                                }else if (result.at(i).second.at(9) == "third party only") {
                ...
                */
                ...
                cout << "6. Back" << endl;
                int benefitsChoice = validInput();// was choice9
                if (benefitsChoice == 1) {
                    cout << "New sign-up Discounts" << endl;
                    cout << "When you sign up for a policy with Mors Mutual Insurance, you will receive a 10% discount on your first month's payment." << endl;//placeholder text
                    cout << "Press enter twice to continue" << endl;
                    cin.ignore();
                    cin.get();
                    if (cin.get()) {
