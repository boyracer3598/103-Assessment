...
double calculateQuote(int age, int gender, int licenseStatus, int insuranceType, int vehicleType) {
    double baseQuote;
    //reads customer registration csv file to find discount percentage
...
//create new account in csv file
void createAccount() {
    cin.ignore(1000, '\n');
    cin.clear();
                        ...
                        for (int i = 0; i < result.size(); i++) {
                            if (result.at(i).first == currentUsername) {
                                ...
                                if (renewChoice == "y" || renewChoice == "Y") {
                                    ...
                                    cout << "please enter your license status (3 for learners, 2 for ristricted, 1 for full)" << endl;
                                    string licenseChoice;
                                    cin.clear();
                                    getline(cin, licenseChoice);
                                    while (licenseChoice != "1" && licenseChoice != "2" && licenseChoice != "3") {
                                        cout << "Invalid input, please enter '3' for learners, '2' for restricted and '1' for full" << endl;
                                        cin.clear();
                                        getline(cin, licenseChoice);
                                    }
...
void AdminConsole() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            cout << "please enter the type of policy you would like to update (1 for comprehensive, 2 for third party fire & theft, 3 for third party only): ";
            int policyType = validInput();
            if (policyType == 1) {
                cout << "you are editing the comprehensive policy" << endl;
                cout << "please enter the new information paragraph for the comprehensive policy: " << endl;
                string newInfo;
                cin.clear();
                cin.ignore(1000, '\n');
                getline(cin, newInfo);
                ...
                cout << "please enter the new information paragraph for the third party fire & theft policy: " << endl;
                string newInfo;
                cin.clear();
                cin.ignore(1000, '\n');
                getline(cin, newInfo);
                ...
                cout << "please enter the new information paragraph for the third party only policy: " << endl;
                string newInfo;
                cin.clear();
                cin.ignore(1000, '\n');
                getline(cin, newInfo);
